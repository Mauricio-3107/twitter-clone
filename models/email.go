...
const (
	...
	DefaultSender = "support@twitter.com"
)
...
type EmailService struct {
	// DefaultSender is used as the default sender when one isn't provided for an email. This is also used in functions where the email is a predetermined, like the forgotten password email.
